...
## Trainer Shiny Pokemon Feature
This branch allows you to make some trainers' Pokemon shiny by setting the IV field on the team.

It leverages the EV spread feature and sets up one EV spread (121) which forces shiny.
